...
<div class="content">
    <div class="page-inner">
        ...
        <!-- Modal Add Customer -->
        <div class="modal fade" id="addDataCustomer" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="modal-title">
                            <span class="fw-mediumbold">
                                TAMBAH DATA CUSTOMER</span>
                        </h5>
                        ...
                        <form>
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" id="nama" onkeyup="codeRef()" class="form-control"
                                        placeholder="Nama" oninvalid="this.setCustomValidity('Nama tidak boleh kosong')"
                    ...
                    <div class="modal-footer no-bd">
                        ...
                        <button type="button" class="btn btn-primary btn-sm saveCustomer">Simpan
                            Data</button>
                    </div>
                </div>
            </div>
        ...
        <!-- Edit Data Customer -->
        <div class="modal fade" id="editDataCustomer" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header ">
                        <h5 class="modal-title">
                            <span class="fw-mediumbold">
                                EDIT DATA CUSTOMER</span>
                        </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="row">
                                ...
                                <div class="col-sm-4 mt-2">
                                    <label>Tanggal Lahir<span class="text-danger">*</span></label>
                                    <input type="date" id="tgl_lahir_edit" class="form-control" placeholder="Nama"
                                        required oninvalid="this.setCustomValidity('Tanggal Lahir tidak boleh kosong')"
                                        oninput="setCustomValidity('')" />
                                </div>
                                <div class="col-sm-4 mt-2">
                                    <label>Nomor Whatsapp<span class="text-danger">*</span></label>
                                    <input type="text" id="nm_wa_edit" class="form-control" placeholder="Nama" required
                                        oninvalid="this.setCustomValidity('Nomor Whatsapp tidak boleh kosong')"
                                        oninput="setCustomValidity('')" />
                                </div>
                            </div>
                    ...
                    <div class="modal-footer no-bd">
                        <button type="button" class="btn btn-danger btn-sm" data-dismiss="modal">Batal</button>
                        <button type="button" class="btn btn-primary btn-sm saveEditCustomer">Simpan
                            Perubahan
                            Data</button>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card">
                            ...
                            <?php 
                                foreach($data_customer_by_id as $s){ 
                            ...
                            <div class="card-body ml-2 mr-2">
                                ...
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <button onclick="editClickCustomer('<?= $ed ?>')"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="tables-customer" class="display table table-striped table-hover">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Nama</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <td>
                                            ...
                                            <div classs="btn-group" role="group">
                                                <a href="#" title="" class="btn btn-danger delCustomer btn-sm mb-2">
